 ...
 */
class os_targetpayInstallerScript
{
    ...
    function updateDatabaseSchema()
    {
        ...
        ('os_targetpay', 'Payment via Targetpay', 'DigiWallet.nl', '25-10-2017', 'Copyright 2017 DigiWallet.nl', 'http://www.gnu.org/licenses/old-licenses/gpl-2.0.html GNU/GPL version 2', 'techsupport@targetmedia.nl', 'https://www.digiwallet.nl', '1.1', 'Targetpay Payment Plugin For Joom Donation Extension', NULL, 0, 1);";
        $db->setQuery($sql);
        $db->execute();
    }
    ...
    function uninstall($parent)
    {
        $db = JFactory::getDbo();
        // deactive targetpay
        $sql = "DELETE FROM `#__jd_payment_plugins` WHERE `name` = 'os_targetpay';";
        $db->setQuery($sql);
        $db->execute();
        //delete view file
        $viewFolder = JPATH_ROOT . '/components/com_jdonation/view/targetpay';
